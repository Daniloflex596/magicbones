...
/**
 * Orologio locale. UNICA modifica rispetto all'asset originale della skill:
 * `THREE.Clock` e deprecato nelle versioni recenti di Three e stampa un warning
 * in console a ogni avvio — e la checklist di consegna pretende 0 warning.
 * `THREE.Timer` avrebbe una semantica diversa (va aggiornato a mano nel loop),
 * quindi qui si replica esattamente il comportamento di Clock usato sotto:
 * `getDelta()` = secondi dall'ultima chiamata, `elapsedTime` = totale.
 */
