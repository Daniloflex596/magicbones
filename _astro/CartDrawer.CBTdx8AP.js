import{o as e,t}from"./react.BRNZa73l.js";import{f as n,t as r}from"./proxy.DC6z9cys.js";import{t as i}from"./AnimatePresence.DA4JTVXO.js";import{n as a,r as o}from"./cartStore.FfWhiFCh.js";var s=e(t(),1),c=`393283632440`,l=`magicbones111@gmail.com`;function u(e){return new Intl.NumberFormat(`it-IT`,{style:`currency`,currency:`EUR`,maximumFractionDigits:0}).format(e)}function d(e,t,n,r){return[`Richiesta ordine Magic Bones — ${t||`senza nome`}`,``,...e.map(e=>`• ${e.title} × ${e.quantity} — ${u(e.price*e.quantity)}${e.isCustom?` (personalizzabile — da confermare)`:``}`),``,`Totale indicativo: ${u(e.reduce((e,t)=>e+t.price*t.quantity,0))}`,``,`Contatto: ${n||`da specificare`}`,r?`Note: ${r}`:``].filter(Boolean).join(`
`)}function f(e,t,n,r){let i=d(e,t,n,r);return`https://wa.me/${c}?text=${encodeURIComponent(i)}`}function p(e,t,n,r){let i=`Richiesta ordine Magic Bones — ${t||`nuovo cliente`}`,a=d(e,t,n,r);return`mailto:${l}?subject=${encodeURIComponent(i)}&body=${encodeURIComponent(a)}`}var m=n();function h({items:e,onSent:t}){let[n,i]=(0,s.useState)(``),[a,o]=(0,s.useState)(``),[c,l]=(0,s.useState)(``),[u,d]=(0,s.useState)(null);function h(r){let i=r===`whatsapp`?f(e,n,a,c):p(e,n,a,c);window.open(i,r===`whatsapp`?`_blank`:`_self`),d(r),t()}return u?(0,m.jsxs)(r.div,{initial:{opacity:0,y:8},animate:{opacity:1,y:0},className:`order-confirm`,children:[(0,m.jsx)(`p`,{children:u===`whatsapp`?`Si è aperta una chat WhatsApp con il tuo riepilogo già scritto: invia il messaggio per completare la richiesta.`:`Si è aperto il tuo client email con il riepilogo già scritto: invia il messaggio per completare la richiesta.`}),(0,m.jsx)(`p`,{className:`order-confirm__note`,children:`Claudia ti risponderà personalmente per confermare disponibilità e spedizione.`})]}):(0,m.jsxs)(`form`,{className:`order-form`,onSubmit:e=>{e.preventDefault(),h(`whatsapp`)},children:[(0,m.jsxs)(`label`,{children:[`Nome`,(0,m.jsx)(`input`,{value:n,onChange:e=>i(e.target.value),placeholder:`Il tuo nome`,required:!0})]}),(0,m.jsxs)(`label`,{children:[`Contatto (email o telefono)`,(0,m.jsx)(`input`,{value:a,onChange:e=>o(e.target.value),placeholder:`Dove risponderti`,required:!0})]}),(0,m.jsxs)(`label`,{children:[`Note (misure, personalizzazioni, colori…)`,(0,m.jsx)(`textarea`,{value:c,onChange:e=>l(e.target.value),rows:3,placeholder:`Facoltativo`})]}),(0,m.jsxs)(`div`,{className:`order-form__actions`,children:[(0,m.jsx)(`button`,{type:`submit`,className:`btn btn--primary`,children:`Invia su WhatsApp`}),(0,m.jsx)(`button`,{type:`button`,className:`btn btn--ghost`,onClick:()=>h(`email`),children:`Invia via email`})]}),(0,m.jsx)(`style`,{children:`
